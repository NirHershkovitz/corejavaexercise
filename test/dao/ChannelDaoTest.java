...
public class ChannelDaoTest {
    ...
    private ChannelDao classUnderTest;
...
//    Product product= new Product("1234567890", "class1", "class2", "class3", "cta1");
    ...
    Channel channel = new Channel("name1", 123456789, null, null, 987654321, null);

    @Before
    public void setUp() throws Exception {
        JdbcTemplate jdbcTemplate =UtilClass.setUp();
        classUnderTest = new ChannelDao(jdbcTemplate);
    }

    @Test
    public void shouldFindTheChannelThatWasSaved() {
        classUnderTest.save(channel);//, account, adGroup, product);
